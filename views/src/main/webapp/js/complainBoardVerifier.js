...
function checkNewFeedBack() {
	...
	var text = document.getElementById("text").value.replace(/\s+/, '');
	var textL = document.getElementById("textL");

//	var organization = document.getElementById("organization");
//	var organizationL = document.getElementById("organizationL");

	var rateL = document.getElementById("rateL");
	...
	if (text.length) {
		...
		filled = false;
		textL.style.color = "#b94a48";
	}

//	if (organization.options.selectedIndex == 0) {
//		filled = false;
//		organizationL.style.color = "#b94a48";
//	} else {
//		organizationL.style.color = "black";
//	}
	if (rate.options.selectedIndex == 0) {
		filled = false;
		rateL.style.color = "#b94a48";
	} else {
		rateL.style.color = "black";
	}

	if (filled) {
		addFeedback.action = '/app/postNewFeedback';
		addFeedback.submit();
	} else {
...
function chooseOrganization(organizationName) {
    var table = document.getElementById("organizationsTable");
    table.orgName.value = organizationName;
    table.submit();
}
...
function editOrganization() {
    ...
    if (passed) {
        document.getElementById("organizationModify").submit();
    } else {
        message.style.display = "block";
    }
}
